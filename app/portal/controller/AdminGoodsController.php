...
use app\portal\model\PortalGoodsModel;
use app\portal\service\GoodsService;
use app\portal\model\PortalCateModel;
use think\Db;
...
class AdminGoodsController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $portalCategoryModel = new PortalCateModel();
    ...
    public function add()
    {
        ...
        $articleThemeFiles = $themeModel->getActionThemeFiles('portal/Goods/index');
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $portalPostModel = new PortalGoodsModel();
            ...
            $this->success('添加成功!', url('AdminGoods/edit', ['id' => $portalPostModel->id]));  
        }
    ...
    public function delete()
    {
        ...
        if (isset($param['id'])) {
            ...
            if ($resultPortal) {
                Db::name('portal_cate_goods')->where(['post_id'=>$id])->delete();
                // ->update(['status'=>0]);
