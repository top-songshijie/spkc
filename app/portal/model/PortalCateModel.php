...
class PortalCateModel extends Model
{
...
//        }
        ...
        foreach ($categories as $item) {
            ...
            $item['str_action'] = '<a href="' . url("AdminCate/add", ["parent" => $item['id']]) . '"></a>  <a href="' . url("AdminCate/edit", ["id" => $item['id']]) . '">' . lang('EDIT') . '</a>  <a class="js-ajax-delete" href="' . url("AdminCate/delete", ["id" => $item['id']]) . '"> </a> ';
